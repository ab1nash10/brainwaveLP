    ...
    <Section id={"how-to-use"}>
      <div className="container">
        ...
        <div className="relative">
          <div
            className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/0 rounded-3xl overflow-hidden lg:p-20 
            xl:h-[46rem]"
          >
            ...
            <Generating
              className={`absolute left-4 right-4 bottom-4  border-n-1/10 border lg:left-1/2 lg:right-auto lg:bottom-8 lg:-translate-x-1/2 w-[20rem]`}
            />
          </div>
          <div className={`relative z-1 grid gap-5 lg:grid-cols-2`}>
            ...
            >
                ...
                <ul className="flex items-center justify-between">
                  {brainwaveServicesIcons.map((icons, index) => (
                    ...
                    >
                      ...
                      >
                        <img src={icons} width={24} height={24} alt="items" />
                      </div>
                    </li>
                  ))}
                </ul>
              ...
              <div
                className={`relative h-[20rem] rounded-xl overflow-hidden bg-n-8 md:h-[25rem]`}
              >
                <img
                  src={service3}
                  alt="scaryRobot"
